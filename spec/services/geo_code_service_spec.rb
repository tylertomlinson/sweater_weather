...
RSpec.describe GeoCodeService, :vcr do
  ...
  it 'can get lat and long of given location' do
    location_input = GeoCodeService.new.get_coords('denver,co')
    ...
    location_input = GeoCodeService.new.get_coords('jacksonville,fl')
  ...
  it 'returns nil for invalid search' do
    location_input = GeoCodeService.new.get_coords('abcd,ef')
